...
def seq2seq_args_parser():
    ...
    parser.add_argument('--Train_p', type=int, default=0.5, help='Train %')  # Training Data percentage
    parser.add_argument('--Valid_p', type=int, default=0.2, help='Validation %')  # Validation Data percentage
    parser.add_argument('--Test_p', type=int, default=0.3, help='Test %')  # Test Data percentage

    parser.add_argument('--Filter_SG', type=bool, default=False, help='apply SG Filter')  # True means apply SG filter
